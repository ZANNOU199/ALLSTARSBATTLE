...
import { Plus, Trash2, Edit, Save, X, Users, Settings, Instagram, Facebook, Twitter, Linkedin } from 'lucide-react';

export default function OrganizersAdmin({ data, setData }: { data: CMSData, setData: React.Dispatch<React.SetStateAction<CMSData>> }) {
  ...
  const handleUpdate = () => {
    ...
    setData(prev => ({
      ...prev,
      organizers: prev.organizers?.map(o => 
        o.id === editingId 
          ? { ...o, ...formData } 
          : o
      ) || []
