...
const Participate = ({ onBack, data }: { onBack?: () => void, data?: any }) => {
  ...
  const handleSubmit = (type: 'dancers' | 'professionals' | 'volunteers') => {
      ...
      <section className="relative min-h-[60vh] flex flex-col items-center justify-center text-center px-6 overflow-hidden grainy-bg pt-32">
        <div className="absolute inset-0 z-0">
          <div 
            ...
            style={{ backgroundImage: 'url("https://images.unsplash.com/photo-1504384308090-c894fdcc538d?auto=format&fit=crop&q=60&w=1920")' }}
          ></div>
